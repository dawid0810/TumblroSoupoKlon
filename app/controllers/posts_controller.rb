class PostsController < ApplicationController
  ...
  private
    ...
    def post_params
      params.require(:post).permit(:title, :post_id, :notes_attributes => [:id, :body, :_destroy, :order], :images_attributes => [:id, :file, :_destroy, :upload_file_name, :upload_content_type, :tempfile, :order, :caption, :source])
    end
